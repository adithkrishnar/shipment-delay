...
class SimulationRequest(BaseModel):
    ...
    inventory_delta: float = Field(0.0, ge=-1000000, le=1000000)
    delay_days: float = Field(0.0, ge=0, le=365)
    lead_time_delta: float = Field(0.0, ge=-365, le=365)
    incoming_delta: float = Field(0.0, ge=-1000000, le=1000000)
    reorder_delta: float = Field(0.0, ge=-1000000, le=1000000)
